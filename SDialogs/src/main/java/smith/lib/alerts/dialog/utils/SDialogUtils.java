...
public class SDialogUtils {
    ...
    public static class SwipeSpinner {
         ...
         */
        public static class SwipeSpinnerHelper {
            ...
            @NonNull
            @Contract("_ -> new")
            public static SwipeSpinnerHelper bindRecyclerView(@NonNull SRecyclerView recyclerView) {
            ...
            private SwipeSpinnerHelper(@NonNull final SRecyclerView recyclerView) {
